...
export class MyBee extends CGFobject {
    constructor(scene) {
        ...
        // Objects
        this.head = new MySphere(this.scene, 16, 8, 5, true);
        this.leftEye = new MySphere(this.scene, 16, 8, 2, true);
        this.rightEye = new MySphere(this.scene, 16, 8, 2, true);
        this.torax = new MySphere(this.scene, 16, 8, 5, true);
        this.adbomen = new MySphere(this.scene, 16, 8, 6, true);
    ...
    initMaterials() {
      ...
      this.headMaterial.setAmbient(0.05, 0.05, 0.05, 0.0);
      this.headMaterial.setDiffuse(0.05, 0.05, 0.05, 0.0);
      this.headMaterial.setSpecular(1, 1, 1, 0.0);
